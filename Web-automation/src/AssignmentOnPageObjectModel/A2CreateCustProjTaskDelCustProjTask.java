...
public class A2CreateCustProjTaskDelCustProjTask {
	...
	private static void createTask()
	{
		try
		{
			...
			Thread.sleep(2000);
			opage.getenterTaskName().sendKeys("login page");
			Thread.sleep(2000);
			opage.gettaskDescImg().click();
			Thread.sleep(2000);
			opage.geteditDescriptionPopupText().sendKeys("login page description");
			Thread.sleep(2000);
			opage.getsetDeadLine().click();
			Thread.sleep(2000);
			//opage.getselectDateFromCalender().click();
			//Thread.sleep(4000);
