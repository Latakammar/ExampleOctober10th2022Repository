...
public class A2CreateModifyDeleteCustomer {
	...
	private static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			//opage.getcustomerNameEdit().clear();
			//Thread.sleep(2000);
			//opage.getcustomerNameEdit().sendKeys("IRCTC project");
			//Thread.sleep(2000);
			opage.getcustomerDescEdit().clear();
			Thread.sleep(2000);
			opage.getcustomerDescEdit().sendKeys("IRCTC Railway project description");
			Thread.sleep(2000);
			opage.getcustomerEditClose().click();
			Thread.sleep(2000);
